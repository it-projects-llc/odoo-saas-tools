...
$(document).ready(function() {
    $('#rootwizard').bootstrapWizard({
        'tabClass': 'hidden',
        'nextSelector': 'a.tab-next',
        'previousSelector': 'a.tab-prev'
    });
    $('.plan_choice a.tab-next').click(function(){
        var id = $( this ).data('planid');
        var name = $('.plan-name', this).html();
        $('#plan-id-hidden').val(id);
        $('#summary-plan_name').html(name);
    });
